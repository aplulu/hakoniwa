...
*   `metadata.annotations`:
    ...
    *   `hakoniwa.aplulu.me/volume-class`: (Optional) The StorageClass to use for the persistent volume claim. If omitted, the cluster's default StorageClass is used.
